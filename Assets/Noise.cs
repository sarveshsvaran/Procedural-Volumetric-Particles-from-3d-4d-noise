...
public static class Noise  {
    ...
    public static float Sum(NoiseMethod method,Vector3 point, float frequency,int octaves,float lacunarity,float persistance)
    {
    ...
    private static float Dot(Vector2 a,float x, float y)
    {
        return a.x * x + a.y * y;
    }

    private static float Dot(Vector3 a, float x, float y,float z)
    {
